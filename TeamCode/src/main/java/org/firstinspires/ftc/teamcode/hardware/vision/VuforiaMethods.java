...
public class VuforiaMethods {
    ...
    //Basic constructor
    public VuforiaMethods(HardwareMap hardwareMap){
    ...
    public void initVuforia(){
        ...
        final float CAMERA_FORWARD_DISPLACEMENT  = 9.0f * (float) Constants.MM_PER_IN;   //Camera is 8 Inches in front of robot center
        final float CAMERA_VERTICAL_DISPLACEMENT = 4f * (float) Constants.MM_PER_IN;   //Camera is 7.5 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = 5.0f * (float) Constants.MM_PER_IN;   //Camera is 4 inches left of the robot's center line
    ...
    public int getRings(){
        ...
        if (tfod != null) {
            ...
            //left top is less than or great than 90
